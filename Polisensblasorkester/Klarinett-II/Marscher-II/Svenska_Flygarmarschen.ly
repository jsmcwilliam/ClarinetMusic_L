...
%}
  \score {
    ...
    \repeat volta 2 { %startrep 
    	    ...
    	    bes4.( c8) c4 c      | % 23
    	    c f a c      | % 24
    	    a \p \times 2/3{c,8( d c)  } b4 c      | % 25
    	    e r bes'2~      | % 26
    	    bes4 \times 2/3{c,8( d c)  } b4 c      | % 27
    	    f r a2~      | % 28
    	    a4 f \ff e f      | % 29
    	    d4.( e8) e4 c      | % 30
    	    bes4.( c8) c4 c      | % 31
    	    c f a c      | % 32
    	    a \times 2/3{c,8( d c)  } b4 c      | % 33
    	    d4. cis8 d4 c      | % 34
    	    bes a g f 
    ...
    %barkeysig: 
    \key bes \major 
    f'4 ^\markup {\upright  "TRIO"} \fz r r2 
    \bar "||"     | % 39
    r1      | % 40
