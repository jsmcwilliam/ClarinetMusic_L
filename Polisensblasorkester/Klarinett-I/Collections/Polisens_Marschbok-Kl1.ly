...
\pageBreak
  ...
  \bookpart {
	...
	\tocSection \markup { \concat 
	                    {"Underh" \char#229 "llningsmusiken"} }		
  ...
  \pageBreak
    ...
    \tocItem \markup {"12. Klinga mina Klockor"}
