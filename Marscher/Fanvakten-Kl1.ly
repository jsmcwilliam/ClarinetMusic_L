  ...
  \score {
    ...
    \relative c'' { 
        ...
        \repeat volta 2 {
    	    ...
    	    f4 r c2~-> |\times 2/3 {c4\< c, d} \times 2/3 { ees f g\!} 
...
%    	    \phrasingSlurDown
    	    \acciaccatura { bes16[c d] } ees4\ff^\markup {\bold {Trio}} r r2
    	    \OneBR
    	    \repeat volta 2 {
    	    	 ...
    	    	 ees4.\<) f8 ( \times 2/3 {g4 aes bes) } |c1~\! 
    	    	 c4\mf \times 2/3 {c8 (d c)} b4\< c |c r aes r |g\! r f r
    	    	 ees\f r8 c' bes2~ |bes4\ff \times 2/3 {bes8 (c bes)} a4 bes
    	    	 \times 2/3 {d4 (c bes)} aes4 g |f r bes r |ees, r ees' r8 ees
    	    	 }
    	    	 \alternative {
    	    	 	 {ees4 r r2}
    	    	 	 {ees4 r r2}
